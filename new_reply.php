...
?>
				...
				<form action="upload_file.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" >
										<input type="file" name="file" id="file"/>
										<button type="submit" name="btn-upload" onclick="window.open('view.php')">Upload</button><br>
								</form>
								 <?php
